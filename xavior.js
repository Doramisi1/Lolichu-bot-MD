...
⭔ Detail: ${detail}`
            ...
            case 'psikopat1': {} break
            case 'psikopat2': {} break
            case 'undian': {} break
            case 'xaviorofc': {} break
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Hai ${pushname} kamu gabut?\n\nsaya ada rekomendasi game gabut nih\n`,
                    buttonText: "LIST GAME",
                    footerText: "XaviorDevGame.com",
                    listType: "SINGLE_SELECT",
                    sections: [{
								"title": "Web XaviorGame🃏",
								"rows": [
									{
